...
INSERT INTO REGIAO (NOME) SELECT DISTINCT REGIAO FROM RECLAMACAO_DES ORDER BY ASC;
...
INSERT INTO CIDADE (NOME, IDESTADO)
  SELECT DISTINCT CIDADE, IDESTADO FROM RECLAMACAO_DES RD JOIN ESTADO E ON RD.ESTADO = E.NOME;
...
INSERT INTO SEGMENTO (DESCRICAO) SELECT DISTINCT SEGMENTOMERCADO FROM RECLAMACAO_DES ORDER BY ASC;
...
INSERT INTO EMPRESA (NOMEFATASIA, IDAREA)
  SELECT DISTINCT NOMEFATASIA, IDAREA FROM RECLAMACAO_DES RD JOIN AREA A ON RD.AREA = A.DESCRICAO;
